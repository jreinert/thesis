...
\code{MenuLevel}, \code{MenuLevelItem} und \code{Item}.  Die Komponente
...
gespeichert.  In \code{items.collection.items} befindet sich die Liste aller
Items.
...
darin ein \code{Item} sowie das neue \code{MenuLevel} ausgegeben.  Dem
